...
class QuoteRepository {
    ...
    suspend fun addQuoteToCollection(collectionId: Long, quoteId: Long) =
        withContext(Dispatchers.IO) {
            ...
            if (existing == null) {
                postgrest["collection_items"].insert(
                    CollectionItem(
    ...
    suspend fun getQuotesByCollection(collectionId: Long): List<Quote> =
        withContext(Dispatchers.IO) {
    ...
    suspend fun removeQuoteFromCollection(collectionId: Long, quoteId: Long) =
        withContext(Dispatchers.IO) {
